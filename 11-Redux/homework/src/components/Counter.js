    ...
    render() {
        ...
        return (
            <p>
                ...
                <button onClick={() => this.props.dispatch(this.props.increment())}>
                    + {/* Incremeta */}
                </button>
                <button onClick={() => this.props.dispatch(this.props.decrement())}>
                    -  {/* Decrementa */}
                </button>
...
export default connect(mapStateToProps, dispatch => ({ dispatch, increment, decrement }))(Counter);
